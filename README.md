...
| Form Page Input      | Fields/Elements                | Test Case                          | Steps                                                                           | Expected Outcome                                                                                                  |
|----------------------|--------------------------------|------------------------------------|---------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| Create Profile       | All fields                     | Valid inputs                       | Fill all required fields with valid data                                        | Profile is created successfully and user is redirected to the profile page.                                       |
|                      | All fields                     | Missing required fields            | Leave some required fields empty                                                | Form displays error messages indicating which fields are required.                                                |
|                      | Date of Birth                  | Invalid date format                | Enter invalid date in the date of birth field                                   | Form displays error message indicating invalid date format.                                                       |
|                      | Phone                          | Invalid phone number               | Enter non-numeric characters in the phone field                                 | Form displays error message indicating invalid phone number format.                                               |
| Create Trip          | All fields                     | Valid inputs                       | Fill all required fields with valid data                                        | Trip is created successfully and user is redirected to the trip detail page.                                       |
|                      | All fields                     | Missing required fields            | Leave some required fields empty                                                | Form displays error messages indicating which fields are required.                                                |
|                      | Travel Date, Return Date       | Invalid date range                 | Enter a return date earlier than the travel date                                | Form displays error message indicating the return date must be after the travel date.                              |
|                      | Number of People               | Non-numeric people count           | Enter non-numeric characters in the number of people field                      | Form displays error message indicating the number of people must be a numeric value.                               |
| Update Profile       | All fields                     | Valid inputs                       | Fill all required fields with valid data                                        | Profile is updated successfully and user is redirected to the profile page.                                       |
|                      | All fields                     | Missing required fields            | Leave some required fields empty                                                | Form displays error messages indicating which fields are required.                                                |
|                      | Date of Birth                  | Invalid date format                | Enter invalid date in the date of birth field                                   | Form displays error message indicating invalid date format.                                                       |
|                      | Phone                          | Invalid phone number               | Enter non-numeric characters in the phone field                                 | Form displays error message indicating invalid phone number format.                                               |
| Update Trip          | All fields                     | Valid inputs                       | Fill all required fields with valid data                                        | Trip is updated successfully and user is redirected to the trip detail page.                                       |
|                      | All fields                     | Missing required fields            | Leave some required fields empty                                                | Form displays error messages indicating which fields are required.                                                |
|                      | Travel Date, Return Date       | Invalid date range                 | Enter a return date earlier than the travel date                                | Form displays error message indicating the return date must be after the travel date.                              |
|                      | Number of People               | Non-numeric people count           | Enter non-numeric characters in the number of people field                      | Form displays error message indicating the number of people must be a numeric value.                               |
| Delete Profile       | Delete Button                  | Confirm delete action              | Click the delete button and confirm the action                                  | Profile is deleted successfully and user is redirected to the profile list or home page.                          |
|                      | Delete Button                  | Cancel delete action               | Click the delete button but cancel the action                                   | Profile is not deleted, and user remains on the profile page.                                                     |
| Delete Trip          | Delete Button                  | Confirm delete action              | Click the delete button and confirm the action                                  | Trip is deleted successfully and user is redirected to the trip list page.                                         |
|                      | Delete Button                  | Cancel delete action               | Click the delete button but cancel the action                                   | Trip is not deleted, and user remains on the trip detail page.                                                    |
| Search Trips         | Search Field                   | Valid search query                 | Enter a valid trip name or destination in the search field                      | Search results are displayed with matching trips.                                                                 |
|                      | Search Field                   | No matching search query           | Enter a trip name or destination that does not exist                            | No search results are displayed, and a message indicating no matches found is shown.                              |
|                      | Search Field                   | Empty search query                 | Leave the search field empty and submit the form                                | All trips are displayed (or appropriate message indicating no query provided).                                     |
| Form Common Tests    | CSRF Token                     | CSRF token validation              | Remove or alter the CSRF token and submit the form                              | Form submission fails with a CSRF validation error message.                                                       |
